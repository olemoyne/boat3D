...
public class GabaritsTreeNode extends DesignTreeNode {
	...
	public Icon getImage() {
		return DesignTreeRenderer.gabaritImg;
	}
	...
	public PrintableScene getScene () {
		...
		for (Gabarit gab : comp.structure.gabarits) {
			ret.add(new PrintedArea(gab.getContours(), gab.position.toString(), false, false, Color.GREEN, new Position()));
		}
