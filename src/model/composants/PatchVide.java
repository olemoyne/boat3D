...
public class PatchVide extends PatchComposant {
	...
	public void calculeElements (){
     	...
     	// Positionne les �l�ments de la structure
     	structure.recalcule(this);
	...
	public ArrayList<PrintableObject> getSceneObjects(Position trans) {
		ArrayList<PrintableObject> ret = super.getSceneObjects(trans);
		
		Apparence app = this.getApparence();
		if (structure.quille != null) {
			if (structure.quille.mapCalcul != null) 
				ret.add(new PrintedMap (structure.quille.mapCalcul, "Quille", !app.transparence, app.couleur, trans));
		} 
