...
**/
   ...
   */
	 ...
	 * @return
	 */
	public static Area getUnion(Area myArea, Area hisArea, Decimal z) {
		if( myArea.points.size() == 0) return myArea;
		Polygon2D myPoly = CalculSurface.getPoly(myArea.points, Axis.ZAxis);
		Polygon2D hisPoly = CalculSurface.getPoly(hisArea.points, Axis.ZAxis);

		Polygon2D resPoly = Polygons2D.union(myPoly, hisPoly); 
		if (resPoly == null) {
			System.err.println("Extruction error : Non polygon");
			return null;
		}
	...
	public static void main (String[] args) {
		...
		res = CalculFormes.getUnion(a1, a2, Decimal.ZERO);
		if (res != null)
			System.out.println("Resultat 1U : "+res.points.toString());
		else System.out.println("Resultat 1U : pas d'intersection");
		...
		res = CalculFormes.getUnion(a1, a3, Decimal.ZERO);
		if (res != null)
			System.out.println("Resultat 2U : "+res.points.toString());
		else System.out.println("Resultat 2U : pas d'intersection");
		...
		res = CalculFormes.getUnion(a4, a5, Decimal.ZERO);
		if (res != null)
			System.out.println("Resultat 3U : "+res.points.toString());
		else System.out.println("Resultat 3U : pas d'intersection");
		...
		res = CalculFormes.getUnion(a1, a14, Decimal.ZERO);
		if (res != null)
			System.out.println("Resultat U11 : "+res.points.toString());
		else System.out.println("Resultat U11 : pas d'intersection");
